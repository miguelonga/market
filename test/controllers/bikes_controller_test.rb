...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { brand: @bike.brand, description: @bike.description, name: @bike.name, price: @bike.price }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { brand: @bike.brand, description: @bike.description, name: @bike.name, price: @bike.price }
    assert_redirected_to bike_path(assigns(:bike))
  end
